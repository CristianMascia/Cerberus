...
| `demo_client.py` | queries every model via il client `cerberus` (thinking separated) |
...
python ../demo_client.py        # or usa `from cerberus import CerberusClient` da your own code
